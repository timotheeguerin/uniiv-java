...
public class DiffUtils
{
	 ...
	 */
	public LinkedList<Diff> diffMain(final String text1, final String text2)
	{
	 ...
	 * @return Linked List of Diff objects.
	 */
	public LinkedList<Diff> diffMain(final String text1, final String text2, final boolean checklines)
	{
