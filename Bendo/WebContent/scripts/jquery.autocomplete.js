		...
		(function($) {
			...
			Autocomplete.prototype = {
				...
				initialize : function() {
					...
					that.suggestionsContainer = Autocomplete.utils.createNode('<div class="' + options.containerClass
				...
				fixPosition : function() {
					...
					// Don't adjsut position if custom container has been
					// specified:
				...
				suggest : function() {
					...
					var that = this, formatResult = that.options.formatResult, value = that.getQuery(that.currentValue), className = that.classes.suggestion, classSelected = that.classes.selected, container = $(that.suggestionsContainer), html = '', width;
				...
				processResponse : function(response, originalQuery) {
					...
					// Display suggestions only if returned query matches
					// current value:
