...
(function($) {
	$.fn.jRating = function(op) {
		var defaults = {
			/** String vars * */
			// path ofthe icon stars.png
			bigStarsPath : 'images/jquery/jrating/stars.png',

			// path of the icon small.png
			smallStarsPath : 'images/jquery/jrating/small.png',

			submitPath : '', // path of the php file jRating.php
			...
			decimalLength : 0, // number of decimals.. Max 3, but you can
			// complete the function 'getNote'
			rateMax : 20, // maximal rate - integer from 0 to 9999 (or more)
			rateInfosX : -45, // relative position in X axis of the info box
			// when mouseover
			rateInfosY : 5, // relative position in Y axis of the info box when
			// mouseover
			nbRates : 1,
			...
			return this
					.each(function() {
									...
									if (submitPath != '') {
										$.post(opts.submitPath, {
											...
											if (!data.error) {
												 ...
												 * box, or use the jNotify
												 * Plugin :)
												 * http://www.myqjqueryplugins.com/jNotify
												 * exemple :
												 */
												if (opts.onSuccess)
						...
						function getStarWidth() {
							switch (opts.type) {
							case 'small':
								starWidth = 12; // width of the picture
								// small.png
								starHeight = 10; // height of the picture
								// small.png
								bgPath = opts.smallStarsPath;
								break;
							default:
								starWidth = 23; // width of the picture
								// stars.png
								starHeight = 20; // height of the picture
								// stars.png
